...
if(isset($_REQUEST['empsubmit'])){
 ...
 if(
  ...
  $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2" role="alert"> Fill All Fileds </div>';
   ...
   $ePasswordHashed = password_hash($ePassword, PASSWORD_BCRYPT, [
    'cost' => 12
   ]);
   $sql = "INSERT INTO technician_tb (empName, empCity, empMobile, empEmail, empPassword) VALUES ('$eName', '$eCity','$eMobile', '$eEmail', '$ePasswordHashed')";
